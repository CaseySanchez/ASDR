...
BerryIMUNode::BerryIMUNode(std::string const &imu_topic, std::string const &mag_topic, int32_t const &FS_G, int32_t const &FS_XL, int32_t const &FS_M) : ros::NodeHandle("~"), m_berry_imu(FS_G, FS_XL, FS_M)
{
...
int main(int argc, char **argv)
{
    ...
    BerryIMUNode berry_imu_node("imu/data_raw", "imu/mag");
